        ...
        "prompt": (
            """{
                "task": [
                    ...
                    "midsole 위로 모든 파트를 펼쳐서 끊김없이 그려줘"
                ],
                "task_rule": [
                    ...
                    "모든 끝선은 가이드라인에 ****최대한 밀착되게 억지로 펼쳐****"
                    "**모든 그림이 삭제/추가 없이 정확하게 나와야해**",
                    "**라인을 넘어가면 패턴을 잘라**"
                ]
            }"""   
        ),
    ...
    },
    {
        ...
        "prompt": (
            """
                {
                    "persona": [
                        "제조때 여분을 주기위한 가이드라인 제공",
                    ],
                    "task": [
                        "패턴을 확장된 라인에 맞춰서 자연스럽게 채워",
                    ],
                    "task_rule": [
                        "실선은 추가/삭제 없이 명확하게 그려줘",
                        "점선은 모두 삭제"
                    ]
                }
            """
