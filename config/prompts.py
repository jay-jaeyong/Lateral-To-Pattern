...
PIPELINE_STEPS: list[dict] = [
    ...
    },
    {
        ...
        "prompt": (
            """{
                "task": {
                    "description": "신발 사진을 보고 중복되는 무늬없이 전개도를 가이드라인에 맞춰 비율을 채울 것",
                    "instructions": [
                        "멀티뷰 그림을 참고해 MIDSOLE 라인 위쪽의 모든 부분을 가이드라인 안에 들어가게 채울것",
                        "추가나 삭제 없이 원본 디자인 요소를 그대로 유지",
                        "망사 패턴이나 검은색으로 채워진 부분은 흰색 배경으로 바꿔줘.",
                        "실은 무늬가 아니야. 실도 실물과 똑같이 그려",
                        "Vamp 쪽을 2번 이미지를 보고, 그다음 1번과 3번을 참고해서 끊김없이 연결해"
                    ]
                },
                "task_rules": {
                    ...
                    "view_mapping": {
                        ...
                        "top_view": "멀티뷰 2번 이미지는 1번과 3번의 vamp를 연결할 때 사용해",
