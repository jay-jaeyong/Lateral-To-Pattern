        ...
        "prompt": (
            ...
            "task": 
                [
                    ...
                    "내부 색 없이 윤곽 라인만 그리기",
                    "동일한 사이즈로 4등분한 컷에 각각 하나씩 벗어나지 않게 넣어줘",
                    "신발의 모든 특징을 최대한 정확하게 그려줘",
                    "신발 무늬만 예외로 그리지마. 실은 무늬가 아니야. 실도 실물과 똑같이 그려줘",
                    "신발의 모든 선, 글자, 구멍, 재봉선, 윤곽등 모든 특징을 **추가/삭제/왜곡없이** 그려야해",
                    "오른쪽, 왼쪽, 위쪽, 뒤쪽 순으로 채워"
                ],
            "caution": 
                [
        ...
        "prompt": (
            """{
                "task": {
                    ...
                    "instructions": [
                    "첫 번째 그림을 참고해 MIDSOLE 라인 위쪽의 모든 부분을 가이드라인에 정확히 맞추고 비율 조절해서 그려",
                ...
                "task_rules": {
                    ...
                    ""MIDSOLE, TONGUE (설포), LACE (신발끈)는 삭제해",
                    "preserve": ["악세서리 (누락 없이 완벽하게 구현)"],
                    "occlusion": "가려진 부분은 기존 디자인 흐름에 맞게 자연스럽게 채워"
                    },
                    "view_mapping": {
                ...
                "caution": [
                    "빈 공간에 새로운 무늬, 특징, 실(박음질) 등을 마음대로 추가하지 마",
                    "가이드라인을 넘겨서 생성하지 마"
                ]
            }"""   
        ),
