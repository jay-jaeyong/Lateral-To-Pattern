...
PIPELINE_STEPS: list[dict] = [
    ...
    },
    {
        ...
        "prompt": (
            """{
                "persona" :{
                    "신발의 Upper부위에 해당하는 파트의 펼쳐진 전개도를 그려야하는 상황. 주어진건 양면 이미지와 TopView 이미지. 가이드라인. 가이드라인에 정확히 맞춰서 Upper를 펼친 전개도를 그려야함"
                },
                "task": {
                    "신발 사진을 보고 전개도 비율을 맞춰 것가이드라인에 채울것"
                    "Upper만 모든 부분을 가이드라인 안에 들어가게 채울것",
                ...
                "task_rules": {
                    ...
                    "악세서리 (누락 없이 완벽하게 구현)",
                    "제공된 가이드라인은 아래쪽이 발등 부분이고 위쪽이 뒷꿈치 부분이야",
                    "부위가 겹치는 경우 오른쪽이 위로 오도록 그려"
                },
                "caution": [
                    "입력 이미지에 없는 선/점선/스티치/패턴은 **절대 생성하지 말고**, 보이지 않으면 비워둬",
                    "**************제공된 가이드라인이 절대적 기준이야. 넘어가면 안돼**************"
                ]
            }"""     
        ),
