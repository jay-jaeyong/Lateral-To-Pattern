        ...
        "prompt": (
            """{
                ...
                "task": [
                    ...
                    "신발의 모든 선, 글자, 구멍, 재봉선, 윤곽, 무늬 등 모든 특징을 **추가/삭제/왜곡없이** 그려",
                    "내부 색 없이 윤곽 라인만 그리기",
        ...
        "prompt": (
            """{
                ...
                "task_rules": {
                    ...
                    "view_mapping": {
                        "lateral_view": "멀티뷰 1번 이미지는 왼쪽 전체, 멀티뷰 3번 이미지는 오른쪽 전체를 채우는 데 사용해",
                        "top_view": "멀티뷰 2번 이미지를 보고 TopView의 아래 부위에 발등 부위의 연결 고리로 자연스럽게 연결해",
