        ...
        "prompt": (
            """{
                ...
                "task": [
                    ...
                    "신발 그림 내부 색 없이 윤곽 라인만 그리기",
                    "1, 2, 3에 입력 순서대로 제공된 칸을 채우고 번호를 써줘",
                    "3번은 발등이 아래로 가게 채줘",
                    "모든 특징을 **추가/삭제/왜곡없이** 그려"
                ],
                "caution": [
                    "모든 선을 정확하게 구분할 것",
                    "****실물과 똑같이 그릴 것****",
        ...
        "prompt": (
            """{
                "task": {
                    ...
                    "instructions": [
                        "멀티뷰 그림을 참고해 MIDSOLE 라인 위쪽의 모든 부분을 가이드라인 안에 차도록 정확히 비율 맞춰 그려",
                        "추가나 삭제 없이 원본 디자인 요소를 그대로 유지",
                        "망사 패턴이나 검은색으로 채워진 부분은 흰색 배경으로 바꿔줘.",
                        "실은 무늬가 아니야. 실도 실물과 똑같이 그려",
                    "*멀티뷰를 참고해서 Vamp를 최대한 자연스럽게 연결하는게 핵심이야*"
                    ]
                },
                "task_rules": {
                ...
                "caution": [
                    ...
                    "절대 단순 좌우 반전이 아닌 첫번째 그림 그대로 제공된 윤곽 라인에 안에 맞춰서 그려줘"
                ]
            }"""     
        ),
            ...
            """
                {
                    ...
                    "caution": [
                        ...
                        "입력 이미지에 없는 선/점선/스티치/패턴은 **절대 생성하지 말고**, 보이지 않으면 비워둬",
                        "가이드라인에 맞춰서 추가되는 *무늬 없이* 이전 무늬를 자연스럽게 확장해줘"
                    ]
                }
            """,
